...
function read_options(){
	...
	if(window.localStorage['lightimagea'] == 'true'){$('lightimagea').checked = true;$('example1').style.background = 'url(' + $('lightimage').value + ')';$('example2').style.background = 'url(' + $('lightimage').value + ')';$('mousespotlighta').disabled = true;$('mousespotlightc').disabled = true;}
...
{$('lightimagen').checked = false;$('example1').style.background = 'url(' + $('lightimage').value + ')';$('example2').style.background = 'url(' + $('lightimage').value + ')';$('lightimage').disabled = false;$('lightcolor').disabled = true;
