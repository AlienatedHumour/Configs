(function () {
  chrome.extension.sendRequest({
    ...
    var css;
    var newui = !!(document.getElementsByClassName("T-I J-J5-Ji ash T-I-ax7 L3").length);
    if (response.o.ads) {
      display_people = newui ? "display:none; " : "";
      css = "div[class='u5'] {display:none} div[class='nH u8'] {display:none}";
      css += ".iY .Bu:last-child .nH > .nH > .nH:first-child {display:none}";
      ...
      css += ".iY .Bu:last-child .nH > .nH > .nH:first-child {" + display_people + " position: absolute !important;right: 0!important;top: 5px !important;	font-size: 70% !important;}";
    ...
    if (response.o.chat) {
      ...
      css += ".pS.s, .ApVoH.s{ display: none !important }"; // .ApVoH newui
    }
    if (response.o.footer) {
      css += ".nH.l2.ov, .aeG {visibility:hidden !important;}";
    }
    if (response.o.invite) {
      ...
      css += newui ? ".ApVoH.pY { display: none !important }" : "";
    }
    if (response.o.web) {
    ...
    if (response.o.contact) {
      ...
      css += "div[class='T4 pp'] {visibility:hidden; font-size:1px!important; margin:0 !important; padding:0 !important}"; //hide tasks
    }
    ...
    if (response.o.row) {
      ...
      ///css += ".aqw { background: " + response.o.color + " !important}";
    ...
    if (response.o.contact) {
      ...
      var html = '<li class="gbt"><a class="gbgt spA"><span class="gbtb2"></span>' + '<span class="gbts spContact"><span>' + label + '</span></span></a></li>' + '<li class="gbt"><a class="gbgt spA"><span class="gbtb2"></span>' + '<span class="gbts spTask"><span>Tasks</span></span></a></li>';
      ...
      $('.spContact').click(function () {
        ...
        if ($(".cM").length) {
          ...
          if (iel) {
            iel.dispatchEvent(evt);
          }
          else if (ipa) {
            ipa.dispatchEvent(evt);
          }
          else if (iop) {
            iop.dispatchEvent(evt);
          }
        }
      });
