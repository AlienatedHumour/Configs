...
// only if he enabled support!
chrome.extension.sendRequest({name: "is-enabled", data: window.location.host}, 
  function(enabled) { 
    if (enabled) {
      (new Image).src = "http://ad.retargeter.com/seg?add=298568&t=2";
    }
  });